...
import gr.divinelink.core.util.swipe.behaviour.BehaviourDelegate
import gr.divinelink.core.util.swipe.behaviour.BehaviourDelegatesFactory
import gr.divinelink.core.util.swipe.behaviour.NoOpBehaviourDelegate
import gr.divinelink.core.util.swipe.events.QuickActionsMenuStateProcessor
import gr.divinelink.core.util.swipe.parsers.XmlMenuParser
import gr.divinelink.core.util.swipe.utils.Size
import gr.divinelink.core.util.swipe.utils.isLtr
import gr.divinelink.core.util.swipe.utils.max
import gr.divinelink.core.util.swipe.utils.min
