...
@Composable
fun SelectGenreModalBottomSheet(
  mediaType: MediaType,
  viewModel: SelectGenreViewModel = koinViewModel(
    key = "SelectGenreModalBottomSheet-${mediaType.value}",
...
private fun SelectGenreContent(
  uiState: SelectGenreUiState,
  onAction: (SelectGenreAction) -> Unit,
) {
  LazyColumn(
    ...
    items(
      ...
      Row(
        modifier = Modifier
          .fillMaxWidth()
          .clickable { onAction.invoke(SelectGenreAction.SelectGenre(genre)) }
          .padding(
