...
import com.divinelink.core.ui.resources.core_ui_jellyseerr_session_expired
import com.divinelink.core.ui.resources.core_ui_login
import com.divinelink.core.ui.snackbar.SnackbarMessage
import com.divinelink.feature.request.media.resources.Res
import com.divinelink.feature.request.media.resources.feature_request_media_cancel_request_failure
import com.divinelink.feature.request.media.resources.feature_request_media_cancel_request_success
import com.divinelink.feature.request.media.resources.feature_request_media_failed_request
import com.divinelink.feature.request.media.resources.feature_request_media_request_exists
import com.divinelink.feature.request.media.resources.feature_request_media_success_request
import com.divinelink.feature.request.media.resources.feature_request_media_update_request_failure
import com.divinelink.feature.request.media.resources.feature_request_media_update_request_success
          ...
          it.fold(
            onSuccess = { response ->
              ...
              val message = UIText.ResourceText(
                Res.string.feature_request_media_update_request_success,
              )
              ...
              _uiState.update { uiState ->
                uiState.copy(
                  ...
                  snackbarMessage = SnackbarMessage.from(
                    text = UIText.ResourceText(
                      Res.string.feature_request_media_update_request_failure,
                    ),
                  ),
                )
              }
        ...
        onSuccess = {
          ...
          _uiState.update {
            it.copy(
              ...
              snackbarMessage = SnackbarMessage.from(
                text = UIText.ResourceText(
                  Res.string.feature_request_media_cancel_request_success,
                ),
              ),
            )
          }
        ...
        onFailure = {
          _uiState.update {
            it.copy(
              ...
              snackbarMessage = SnackbarMessage.from(
                text = UIText.ResourceText(
                  Res.string.feature_request_media_cancel_request_failure,
                ),
              ),
            )
          }
