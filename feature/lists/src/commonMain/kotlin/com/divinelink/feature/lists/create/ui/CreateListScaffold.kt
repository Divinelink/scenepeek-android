    ...
    topBar = {
      AppTopAppBar(
        ...
        text = if (uiState.editMode) {
          UIText.ResourceText(Res.string.feature_lists_edit_list)
        } else {
          UIText.ResourceText(Res.string.feature_lists_add_list)
        },
        actions = {
          TextButton(
            ...
            Text(
              text = if (uiState.editMode) {
                stringResource(UiString.core_ui_edit)
              } else {
                stringResource(UiString.core_ui_create)
              },
