...
class DetailsScreenTest : ComposeTest() {
  ...
  @Test
  fun `test switch between movie tabs`() = uiTest {
  ...
  @Test
  fun `test switch between movie tabs with error`() = uiTest {
    getMovieDetailsUseCase.mockFetchMediaDetails(
      response = flowOf(
        Result.success(
          MediaDetailsResult.DetailsSuccess(
  ...
  @Test
  fun `test empty reviews for movies`() = uiTest {
    getMovieDetailsUseCase.mockFetchMediaDetails(
      response = flowOf(
        Result.success(
          MediaDetailsResult.DetailsSuccess(
  ...
  @Test
  fun navigateToAnotherDetailsScreen() = uiTest {
  ...
  @Test
  fun `test rate dialog is visible when your rating is clicked`() = uiTest {
    getMovieDetailsUseCase.mockFetchMediaDetails(
      response = flowOf(
        Result.success(
  ...
  @Test
  fun `test rate dialog onSubmitRate`() = uiTest {
    fetchAccountMediaDetailsUseCase.mockFetchAccountDetails(
  ...
  @Test
  fun `test viewAll credits does not exist without tv credits`() = uiTest {
    getMovieDetailsUseCase.mockFetchMediaDetails(
      response = flowOf(
        Result.success(
          MediaDetailsResult.DetailsSuccess(
    ...
    onNodeWithText(getString(UiString.core_ui_view_all)).assertDoesNotExist()
  }

  @Test
  fun `test onViewAllRatingsClick shows AllRatingsModalBottomSheet`() = uiTest {
    fetchAccountMediaDetailsUseCase.mockFetchAccountDetails(
      response = flowOf(Result.success(AccountMediaDetailsFactory.NotRated())),
    )
  ...
  @Test
  fun `test onViewAllRatingsClick`() = uiTest {
    fetchAccountMediaDetailsUseCase.mockFetchAccountDetails(
      response = flowOf(Result.success(AccountMediaDetailsFactory.NotRated())),
    )
  ...
  @Test
  fun `test request movie and delete request afterwards`() = uiTest {
    ...
    onNodeWithContentDescription(getString(Res.string.feature_details_request))
      .assertIsDisplayed()
      .performClick()
    ...
    onNodeWithContentDescription(getString(Res.string.feature_details_manage_movie))
      .assertIsDisplayed()
      .performClick()
  ...
  @Test
  fun `test request tv seasons and delete request afterwards`() = uiTest {
    val getServerInstancesUseCase = TestGetServerInstancesUseCase()
    val getServerInstanceDetailsUseCase = TestGetServerInstanceDetailsUseCase()
    ...
    onNodeWithContentDescription(getString(Res.string.feature_details_manage_tv))
      .assertIsDisplayed()
      .performClick()
