...
fun EmptyContentCreditCard(
  ...
  Card(
    ...
    Column(
      ...
      Text(
        text = when (type) {
          MediaType.MOVIE -> stringResource(R.string.feature_details_no_movies_available)
          else -> stringResource(R.string.feature_details_no_tv_shows_available)
        },
      ...
      Text(
        text = when (type) {
          MediaType.MOVIE -> stringResource(R.string.feature_details_no_movies_available_desc, name)
          else -> stringResource(R.string.feature_details_no_tv_shows_available_desc, name)
        },
        textAlign = TextAlign.Center,
