...
import com.divinelink.feature.details.details__fatal_error_fetching_details
import com.divinelink.feature.details.general_error_message
  ...
  sealed class Failure(
    ...
    data class FatalError(
      override val message: UIText = UIText.ResourceText(
        Res.string.details__fatal_error_fetching_details,
      ),
    ) : Failure(
      message = message,
    )
