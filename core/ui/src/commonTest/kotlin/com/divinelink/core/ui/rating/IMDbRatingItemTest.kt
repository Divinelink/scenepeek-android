...
class IMDbRatingItemTest : ComposeTest() {
  ...
  @Test
  fun `test IMDbRating score is visible when ratingDetails is Score`() = uiTest {
  ...
  @Test
  fun `test IMDbRating Skeleton is visible when ratingDetails is Initial`() = uiTest {
    setContentWithTheme {
  ...
  @Test
  fun `test IMDbRating score is not visible when ratingDetails is Unavailable`() = uiTest {
    setContentWithTheme {
