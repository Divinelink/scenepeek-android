...
@Composable
internal fun rememberTopOverPullState(distanceMultiplier: Float = 1f): TopOverPullState {
...
@Composable
internal fun rememberBottomOverPullState(distanceMultiplier: Float = 1f): BottomOverPullState {
  require(distanceMultiplier > 0f) { "The distanceMultiplier must be greater than zero!" }
  val state = remember(Unit) {
...
internal class BottomOverPullState internal constructor(
  private val distanceMultiplier: Float = 1f,
) {
