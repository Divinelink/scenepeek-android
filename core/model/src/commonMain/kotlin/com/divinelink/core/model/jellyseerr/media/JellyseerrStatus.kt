...
sealed interface JellyseerrStatus {
  ...
  enum class Request(
    ...
    UNKNOWN(0, Res.string.core_model_status_unknown, null),
    PENDING(1, Res.string.core_model_request_status_pending, "request-pending"),
    APPROVED(2, Res.string.core_model_request_status_approved, "request-approved"),
    DECLINED(3, Res.string.core_model_request_status_declined, "request-declined"),
    FAILED(4, Res.string.core_model_request_status_failed, "request-failed"),
    ;
  ...
  enum class Season(
    ...
    UNKNOWN(0, Res.string.core_model_status_unknown, null),
    PENDING(1, Res.string.core_model_request_status_pending, "season-pending"),
    PROCESSING(2, Res.string.core_model_status_requested, "season-processing"),
    ;
  ...
  enum class Media(
    ...
    UNKNOWN(1, Res.string.core_model_status_unknown, null),
    PENDING(2, Res.string.core_model_status_pending, "media-requested"),
    PROCESSING(3, Res.string.core_model_status_requested, "media-pending"),
    PARTIALLY_AVAILABLE(
      4,
      Res.string.core_model_status_partially_available,
      "media-partially-available",
    ),
    AVAILABLE(5, Res.string.core_model_status_available, "media-available"),
    DELETED(6, Res.string.core_model_status_deleted, "media-deleted"),
    ;
