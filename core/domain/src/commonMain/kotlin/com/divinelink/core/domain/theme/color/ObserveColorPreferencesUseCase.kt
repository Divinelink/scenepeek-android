...
) : FlowUseCase<Unit, ColorSystem>(dispatcher.default) {
  override fun execute(parameters: Unit): Flow<Result<ColorSystem>> =
    preferenceStorage.colorSystem.map { preference ->
