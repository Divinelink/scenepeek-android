...
import com.divinelink.core.network.details.person.model.PersonCrewCreditApi

object PersonCrewCreditApiFactory {

  fun the40YearOldVirgin() = PersonCrewCreditApi(
    adult = false,
  ...
  fun getSmart() = PersonCrewCreditApi(
    adult = false,
  ...
  fun theIncredibleBurtWonderstone() = PersonCrewCreditApi(
    adult = false,
