    ...
    val page1 = JellyseerrRequests(
      ...
      results = listOf(
        JellyseerrRequest(
          ...
          requestDate = LocalDateTime.parse("2025-09-21T09:37:34"),
          seasons = emptyList(),
          profileName = "SD",
          profileId = 2,
          serverId = 0,
        ...
        JellyseerrRequest(
          ...
          requester = JellyseerrRequesterFactory.scenepeek,
          requestDate = LocalDateTime.parse("2025-09-20T10:55:18"),
          seasons = emptyList(),
          profileName = null,
          profileId = null,
          canRemove = false,
        ...
        JellyseerrRequest(
          ...
          requestStatus = JellyseerrStatus.Request.PENDING,
          requester = JellyseerrRequesterFactory.scenepeek,
          requestDate = LocalDateTime.parse("2025-09-20T10:55:10"),
          seasons = emptyList(),
          profileName = null,
          profileId = null,
          canRemove = false,
        ...
        JellyseerrRequest(
          ...
          requestStatus = JellyseerrStatus.Request.APPROVED,
          requester = JellyseerrRequesterFactory.scenepeek,
          requestDate = LocalDateTime.parse("2025-09-20T10:55:03"),
          seasons = emptyList(),
          profileName = null,
          profileId = null,
          canRemove = true,
        ...
        JellyseerrRequest(
          ...
          requestStatus = JellyseerrStatus.Request.PENDING,
          requester = JellyseerrRequesterFactory.scenepeek,
          requestDate = LocalDateTime.parse("2025-09-20T10:54:51"),
          seasons = emptyList(),
          profileName = null,
          profileId = null,
          canRemove = false,
