...
class ScenePeekAppTest : ComposeTest() {
  ...
  private val networkMonitor = com.divinelink.core.fixtures.core.data.network.TestNetworkMonitor()
  ...
  fun `test re-selecting search tab focuses search bar`() = runTest {
    ...
    with(composeTestRule) {
      ...
      onNodeWithContentDescription(
        getString(com.divinelink.core.ui.UiString.core_ui_toolbar_search_placeholder),
      )
