...
import com.andreolas.movierama.settings.app.account.AccountSettingsFragment
...
class AppSettingsFragment : DSLSettingsFragment(R.string.settings) {
  ...
  private fun getConfiguration(): DSLConfiguration {
    return configure {
      ...
      clickPref(
        title = DSLSettingsText.from(R.string.preferences__account),
        icon = DSLSettingsIcon.from(R.drawable.ic_account_24),
        onClick = {
          updateFragment(AccountSettingsFragment())
        }
      )
