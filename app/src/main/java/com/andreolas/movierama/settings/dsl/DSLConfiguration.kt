...
import gr.divinelink.core.util.mapping.MappingModel
import gr.divinelink.core.util.mapping.MappingModelList
...
class DividerPreference : PreferenceModel<DividerPreference>() {
    override fun areItemsTheSame(newItem: Any) = true
}
...
class RadioListPreference(
    ...
    override fun areContentsTheSame(newItem: Any): Boolean {
        newItem as RadioListPreference
...
class MultiSelectListPreference(
    ...
    override fun areContentsTheSame(newItem: Any): Boolean {
        newItem as MultiSelectListPreference
